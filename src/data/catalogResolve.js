...
export const WORKSHOP_REFERENCE_LABELS = {
  ...
  'batch-gateway': { label: 'Batch Gateway (batch inference API)', maturity: 'See product documentation for release status' },
  'rh-evaluation': { label: 'Evaluation / EvalHub (quality & benchmarks)', maturity: 'Capability area — confirm components with your account team' },
  ...
  'data-science-pipelines': { label: 'Data Science Pipelines (KFP)', maturity: 'Capability on OpenShift AI' },
  elastic: { label: 'Elasticsearch / Elastic vector search', maturity: 'Partner or customer-operated data plane' },
  pgvector: { label: 'pgvector (PostgreSQL extension)', maturity: 'OSS pattern; operational responsibility with customer' },
  ...
  'cpu-only': { label: 'CPU-only footprint', maturity: 'For constrained POCs — validate model size vs latency' },
  'rhel-hosts': {
